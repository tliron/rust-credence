...
See the [example service file](../assets/systemd/credence.service).
...
Remember that you can reset the cache at any time via the `/admin/reset-cache` URL (see above).
