use super::{super::configuration::*, annotations::*, context::*, templates::*};
...
impl RenderedPage {
    ...
    pub fn context<'own>(
        ...
        // Our values override global values
        let mut values = configuration.render.values.clone();
        for (key, value) in &self.annotations.values {
