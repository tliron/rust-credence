...
pub fn cmp_value_lowercase<AnnotationsT>(a: &Value<AnnotationsT>, b: &Value<AnnotationsT>) -> Ordering {
...
/// [QueryMap] to [Value].
pub fn query_map_to_value<AnnotationsT>(query: &QueryMap) -> Value<AnnotationsT>
where
